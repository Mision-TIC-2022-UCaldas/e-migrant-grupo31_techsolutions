...
namespace TechSolution.Controllers
{
    public class MigrantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NId,TId,Nombre,Apellidos,Pais,FechaNacimiento,CorreoElectronico,NTel,DireccionActual,Ciudad,SituacionLaboral")] Migrante migrante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NId,TId,Nombre,Apellidos,Pais,FechaNacimiento,CorreoElectronico,NTel,DireccionActual,Ciudad,SituacionLaboral")] Migrante migrante)
        {
            if (id != migrante.NId)
            {
                return NotFound();
